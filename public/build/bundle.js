...
var app = (function () {
    ...
    // (125:12) {#each visibleVarer as vare, i}
    function create_each_block(ctx) {
    	...
    	function input0_change_handler() {
    		/*input0_change_handler*/ ctx[12].call(input0, /*vare*/ ctx[8]);
    	}

    	function input1_input_handler() {
    		/*input1_input_handler*/ ctx[13].call(input1, /*vare*/ ctx[8]);
    	}

    	function input2_input_handler() {
    		/*input2_input_handler*/ ctx[14].call(input2, /*vare*/ ctx[8]);
    	}

    	function input3_input_handler() {
    		/*input3_input_handler*/ ctx[15].call(input3, /*vare*/ ctx[8]);
    	}

    	function click_handler() {
    		return /*click_handler*/ ctx[16](/*vare*/ ctx[8]);
    	}

    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[17](/*vare*/ ctx[8]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "name", "");
    			attr_dev(input0, "id", "");
    			add_location(input0, file, 127, 19, 4287);
    			set_style(td0, "display", "flex");
    			set_style(td0, "justify-content", "center");
    			set_style(td0, "align-items", "center");
    			set_style(td0, "width", "100%");
    			set_style(td0, "height", "100%");
    			add_location(td0, file, 126, 16, 4168);
    			attr_dev(input1, "type", "text");
    			set_style(input1, "all", "unset");
    			set_style(input1, "width", "100%");
    			set_style(input1, "height", "100%");
    			set_style(input1, "margin", "0px");
    			set_style(input1, "background", "none");
    			add_location(input1, file, 129, 63, 4483);
    			set_style(td1, "color", "#373A86");
    			set_style(td1, "font-weight", "3000");
    			add_location(td1, file, 129, 16, 4436);
    			attr_dev(input2, "type", "text");
    			set_style(input2, "all", "unset");
    			set_style(input2, "width", "100%");
    			set_style(input2, "height", "100%");
    			set_style(input2, "margin", "0px");
    			set_style(input2, "background", "none");
    			add_location(input2, file, 130, 63, 4699);
    			set_style(td2, "font-weight", "500");
    			set_style(td2, "text-align", "left");
    			add_location(td2, file, 130, 16, 4652);
    			attr_dev(input3, "type", "text");
    			set_style(input3, "all", "unset");
    			set_style(input3, "width", "100%");
    			set_style(input3, "height", "100%");
    			set_style(input3, "margin", "0px");
    			set_style(input3, "background", "none");
    			add_location(input3, file, 131, 46, 4899);
    			set_style(td3, "text-align", "center");
    			add_location(td3, file, 131, 16, 4869);
    			attr_dev(a, "href", "#");
    			add_location(a, file, 134, 18, 5174);
    			set_style(td4, "text-align", "center");
    			add_location(td4, file, 133, 16, 5124);
    			if (!src_url_equal(button.src, button_src_value = "../public/trash_icon.png")) attr_dev(button, "src", button_src_value);
    			set_style(button, "margin", "0px");
    			set_style(button, "box-sizing", "border-box ");
    			...
    			set_style(button, "border-radius", "24px");
    			add_location(button, file, 143, 19, 5553);
    			set_style(td5, "display", "flex");
    			set_style(td5, "justify-content", "center");
    			set_style(td5, "align-items", "center");
    			set_style(td5, "margin", "0px");
    			set_style(td5, "height", "30px");
    			add_location(td5, file, 142, 16, 5435);
    			set_style(tr, "height", "35px");
    			attr_dev(tr, "class", "" + (null_to_empty(/*i*/ ctx[33] % 2 === 0 ? "odd" : "even") + " svelte-1er8x9u"));
    			add_location(tr, file, 125, 14, 4053);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    			append_dev(td0, input0);
    			input0.checked = /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].checked;
    			append_dev(tr, t0);
    			append_dev(tr, td1);
    			append_dev(td1, input1);
    			set_input_value(input1, /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Varenummer);
    			append_dev(tr, t1);
    			append_dev(tr, td2);
    			append_dev(td2, input2);
    			set_input_value(input2, /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Produktnavn);
    			append_dev(tr, t2);
    			append_dev(tr, td3);
    			append_dev(td3, input3);
    			set_input_value(input3, /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Pris);
    			append_dev(tr, t3);
    			append_dev(tr, td4);
    			append_dev(td4, a);
    			append_dev(tr, t5);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*varer, visibleVarer*/ 33) {
    				input0.checked = /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].checked;
    			}

    			if (dirty[0] & /*varer, visibleVarer*/ 33 && input1.value !== /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Varenummer) {
    				set_input_value(input1, /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Varenummer);
    			}

    			if (dirty[0] & /*varer, visibleVarer*/ 33 && input2.value !== /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Produktnavn) {
    				set_input_value(input2, /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Produktnavn);
    			}

    			if (dirty[0] & /*varer, visibleVarer*/ 33 && input3.value !== /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Pris) {
    				set_input_value(input3, /*varer*/ ctx[0][/*vare*/ ctx[8].originalIndex].Pris);
    			}
    		},
    		i: function intro(local) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(125:12) {#each visibleVarer as vare, i}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function header_søgning_binding(value) {
    		/*header_søgning_binding*/ ctx[9](value);
    	}

    	function header_varer_binding(value) {
    		/*header_varer_binding*/ ctx[10](value);
    	}

    	function header_slettetVarer_binding(value) {
    		/*header_slettetVarer_binding*/ ctx[11](value);
    	}
    	...
    	if (/*slettetVarer*/ ctx[4] !== void 0) {
    		header_props.slettetVarer = /*slettetVarer*/ ctx[4];
    	}
    	...
    	function table1_favoriteVisible_binding(value) {
    		/*table1_favoriteVisible_binding*/ ctx[18](value);
    	}

    	function table1_loading_binding(value) {
    		/*table1_loading_binding*/ ctx[19](value);
    	}

    	function table1_images_binding(value) {
    		/*table1_images_binding*/ ctx[20](value);
    	}

    	function table1_varer_binding(value) {
    		/*table1_varer_binding*/ ctx[21](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(th0, "width", "55px");
    			add_location(th0, file, 115, 14, 3668);
    			set_style(th1, "width", "160px");
    			add_location(th1, file, 116, 14, 3710);
    			add_location(th2, file, 117, 14, 3766);
    			set_style(th3, "width", "160px");
    			add_location(th3, file, 118, 14, 3801);
    			set_style(th4, "width", "160px");
    			add_location(th4, file, 119, 14, 3861);
    			set_style(th5, "width", "35px");
    			add_location(th5, file, 120, 14, 3904);
    			set_style(tr, "position", "sticky");
    			set_style(tr, "top", "0px");
    			set_style(tr, "height", "30px");
    			set_style(tr, "overflow", "hidden");
    			set_style(tr, "background-color", "#2B2F42");
    			set_style(tr, "color", "white");
    			add_location(tr, file, 114, 12, 3542);
    			set_style(thead, "border-radius", "15px");
    			add_location(thead, file, 113, 10, 3494);
    			add_location(tbody, file, 123, 10, 3987);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_slettetVarer && dirty[0] & /*slettetVarer*/ 16) {
    				updating_slettetVarer = true;
    				header_changes.slettetVarer = /*slettetVarer*/ ctx[4];
    				add_flush_callback(() => updating_slettetVarer = false);
    			}

    			header.$set(header_changes);

    			if (dirty[0] & /*slettetVarer, varer, visibleVarer, imagegallery*/ 177) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('vare' in $$props) $$invalidate(8, vare = $$props.vare);
    		if ('slettetVarer' in $$props) $$invalidate(4, slettetVarer = $$props.slettetVarer);
    		if ('varer' in $$props) $$invalidate(0, varer = $$props.varer);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*varer, søgning*/ 3) {
