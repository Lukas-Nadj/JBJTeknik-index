...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$4, 40, 12, 1369);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$4, 26, 4, 584);
    			add_location(head, file$4, 25, 0, 573);
    			attr_dev(img, "alt", "Logo");
    			if (!src_url_equal(img.src, img_src_value = "Logo.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "height", "100%");
    			add_location(img, file$4, 31, 4, 719);
    			set_style(p0, "margin", "0px");
    			add_location(p0, file$4, 33, 8, 796);
    			attr_dev(input, "type", "search");
    			attr_dev(input, "name", "");
    			attr_dev(input, "id", "");
    			attr_dev(input, "placeholder", "f.eks. 120144");
    			add_location(input, file$4, 34, 8, 846);
    			attr_dev(div, "class", "search svelte-661rrp");
    			add_location(div, file$4, 32, 4, 767);
    			set_style(p1, "margin", "0px");
    			set_style(p1, "margin-top", "-1px");
    			set_style(p1, "font-size", "small");
    			add_location(p1, file$4, 36, 112, 1054);
    			attr_dev(button0, "class", "but svelte-661rrp");
    			add_location(button0, file$4, 36, 8, 950);
    			attr_dev(button1, "class", "but svelte-661rrp");
    			...
    			add_location(button1, file$4, 37, 8, 1140);
    			attr_dev(button2, "class", "but svelte-661rrp");
    			attr_dev(button2, "id", "fortryd");
    			set_style(button2, "left", /*loading*/ ctx[3] ? '190px' : '155px');
    			set_style(button2, "margin", "0px");
    			set_style(button2, "margin-top", "-1px");
    			set_style(button2, "margin-bottom", "8px");
    			set_style(button2, "font-size", "small");
    			set_style(button2, "position", "absolute");
    			set_style(button2, "bottom", "1px");
    			set_style(button2, "height", "2.5em");
    			set_style(button2, "max-width", "200px");
    			add_location(button2, file$4, 45, 8, 1487);
    			attr_dev(main, "class", "svelte-661rrp");
    			add_location(main, file$4, 30, 0, 708);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", /*save*/ ctx[4], false, false, false, false),
    					listen_dev(button2, "click", /*click_handler_1*/ ctx[7], false, false, false, false)
    				];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	async function regret() {
    		console.log(slettetVarer[0]);
    		let popp = slettetVarer.pop();

    		if (typeof myVariable != "undefined") {
    			varer.push(Object.assign({}, popp));
    			varer.sort((a, b) => a.Varenummer - b.Varenummer);
    			$$invalidate(1, varer);
    		}
    	}

    	const writable_props = ['søgning', 'varer', 'slettetVarer'];
    	...
    	const click_handler_1 = () => {
    		...
    		let vare = {
    			Varenummer: popp.Varenummer,
    			Produktnavn: popp.Produktnavn,
    			Pris: popp.Pris,
    			checked: popp.checked
    		};

    		if (typeof popp !== 'undefined') {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('slettetVarer' in $$props) $$invalidate(2, slettetVarer = $$props.slettetVarer);
    	};
    ...
    class Header extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { søgning: 0, varer: 1, slettetVarer: 2 });
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 57, 10, 1864);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 55, 10, 1710);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "../Assets/pdf-file-placeholder.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = console.log(/*image*/ ctx[8].src));
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 62, 10, 2258);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_each_block$2(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(button, file$2, 67, 10, 2444);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "../Assets/not-found.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "width", "200px");
    			set_style(img, "cursor-events", "none");
    			attr_dev(img, "draggable", "false");
    			add_location(img, file$2, 79, 6, 2832);
    			set_style(p, "margin", "0px");
    			add_location(p, file$2, 80, 6, 2941);
    			attr_dev(div, "class", "center");
    			add_location(div, file$2, 78, 4, 2805);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	let table_outro;
    	let current;
    	let each_value = /*checkedVarer*/ ctx[3];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$1, 54, 12, 1955);
    			set_style(th1, "width", "160px");
    			add_location(th1, file$1, 55, 12, 2003);
    			add_location(th2, file$1, 56, 12, 2047);
    			set_style(th3, "width", "160px");
    			add_location(th3, file$1, 57, 12, 2069);
    			set_style(th4, "width", "160px");
    			add_location(th4, file$1, 58, 12, 2113);
    			set_style(th5, "width", "35px");
    			add_location(th5, file$1, 59, 12, 2154);
    			...
    			add_location(tr, file$1, 53, 10, 1831);
    			set_style(thead, "border-radius", "15px");
    			add_location(thead, file$1, 52, 8, 1785);
    			add_location(tbody, file$1, 62, 8, 2226);
    			...
    			add_location(table, file$1, 51, 4, 1561);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*slettetVarer, varer, checkedVarer, console, imagegallery*/ 29) {
    				each_value = /*checkedVarer*/ ctx[3];
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(51:2) {#if favoriteVisible}",
    		ctx
    	});
    ...
    // (64:10) {#each checkedVarer as item, i}
    function create_each_block$1(ctx) {
    	...
    	function input0_change_handler() {
    		/*input0_change_handler*/ ctx[7].call(input0, /*each_value*/ ctx[15], /*i*/ ctx[16]);
    	}

    	function input1_input_handler() {
    		/*input1_input_handler*/ ctx[8].call(input1, /*each_value*/ ctx[15], /*i*/ ctx[16]);
    	}

    	function input2_input_handler() {
    		/*input2_input_handler*/ ctx[9].call(input2, /*each_value*/ ctx[15], /*i*/ ctx[16]);
    	}

    	function input3_input_handler() {
    		/*input3_input_handler*/ ctx[10].call(input3, /*each_value*/ ctx[15], /*i*/ ctx[16]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "id", "");
    			add_location(input0, file$1, 65, 113, 2466);
    			...
    			add_location(td0, file$1, 65, 14, 2367);
    			attr_dev(input1, "type", "text");
    			...
    			add_location(input1, file$1, 66, 61, 2620);
    			set_style(td1, "color", "#373A86");
    			set_style(td1, "font-weight", "3000");
    			add_location(td1, file$1, 66, 14, 2573);
    			attr_dev(input2, "type", "text");
    			...
    			add_location(input2, file$1, 67, 61, 2813);
    			set_style(td2, "font-weight", "500");
    			set_style(td2, "text-align", "left");
    			add_location(td2, file$1, 67, 14, 2766);
    			...
    			add_location(input3, file$1, 68, 44, 2990);
    			set_style(td3, "text-align", "center");
    			add_location(td3, file$1, 68, 14, 2960);
    			attr_dev(a, "href", "#");
    			add_location(a, file$1, 71, 16, 3238);
    			set_style(td4, "text-align", "center");
    			add_location(td4, file$1, 70, 14, 3190);
    			...
    			add_location(td5, file$1, 79, 14, 3462);
    			set_style(tr, "height", "35px");
    			attr_dev(tr, "class", "" + (null_to_empty(/*i*/ ctx[16] % 2 === 0 ? "odd" : "even") + " svelte-y0g4st"));
    			add_location(tr, file$1, 64, 12, 2288);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    			append_dev(td0, input0);
    			input0.checked = /*item*/ ctx[14].checked;
    			append_dev(tr, t0);
    			append_dev(tr, td1);
    			append_dev(td1, input1);
    			set_input_value(input1, /*item*/ ctx[14].Varenummer);
    			append_dev(tr, t1);
    			append_dev(tr, td2);
    			append_dev(td2, input2);
    			set_input_value(input2, /*item*/ ctx[14].Produktnavn);
    			append_dev(tr, t2);
    			append_dev(tr, td3);
    			append_dev(td3, input3);
    			set_input_value(input3, /*item*/ ctx[14].Pris);
    			append_dev(tr, t3);
    			append_dev(tr, td4);
    			append_dev(td4, a);
    			append_dev(tr, t5);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*checkedVarer*/ 8) {
    				input0.checked = /*item*/ ctx[14].checked;
    			}

    			if (dirty & /*checkedVarer*/ 8 && input1.value !== /*item*/ ctx[14].Varenummer) {
    				set_input_value(input1, /*item*/ ctx[14].Varenummer);
    			}

    			if (dirty & /*checkedVarer*/ 8 && input2.value !== /*item*/ ctx[14].Produktnavn) {
    				set_input_value(input2, /*item*/ ctx[14].Produktnavn);
    			}

    			if (dirty & /*checkedVarer*/ 8 && input3.value !== /*item*/ ctx[14].Pris) {
    				set_input_value(input3, /*item*/ ctx[14].Pris);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(64:10) {#each checkedVarer as item, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 49, 0, 1448);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	async function imagegallery(vn) {
    		...
    		try {
    			...
    			if (imageNames && imageNames.length > 0) {
    				...
    				$$invalidate(6, images = imageNames.map(imageName => ({ name: imageName, src: imageName })));
    			} else {
    	...
    	$$self.$$.on_mount.push(function () {
    		...
    		if (slettetVarer === undefined && !('slettetVarer' in $$props || $$self.$$.bound[$$self.$$.props['slettetVarer']])) {
    			console_1$1.warn("<Table> was created without expected prop 'slettetVarer'");
    		}
    	});

    	const writable_props = ['varer', 'favoriteVisible', 'loading', 'images', 'slettetVarer'];
    	...
    	function input0_change_handler(each_value, i) {
    		...
    		($$invalidate(3, checkedVarer), $$invalidate(0, varer));
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('images' in $$props) $$invalidate(6, images = $$props.images);
    		if ('slettetVarer' in $$props) $$invalidate(2, slettetVarer = $$props.slettetVarer);
    		if ('checkedVarer' in $$props) $$invalidate(3, checkedVarer = $$props.checkedVarer);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*varer*/ 1) {
    			$$invalidate(3, checkedVarer = varer.map((item, index) => ({ ...item, originalIndex: index })).filter(vare => vare.checked === true));
    		}
    	};
    ...
    // (120:12) {#each visibleVarer as vare, i}
    function create_each_block(ctx) {
    	...
    	function input0_change_handler() {
    		/*input0_change_handler*/ ctx[11].call(input0, /*vare*/ ctx[32]);
    	}

    	function input1_input_handler() {
    		/*input1_input_handler*/ ctx[12].call(input1, /*vare*/ ctx[32]);
    	}

    	function input2_input_handler() {
    		/*input2_input_handler*/ ctx[13].call(input2, /*vare*/ ctx[32]);
    	}

    	function input3_input_handler() {
    		/*input3_input_handler*/ ctx[14].call(input3, /*vare*/ ctx[32]);
    	}

    	function click_handler() {
    		return /*click_handler*/ ctx[15](/*vare*/ ctx[32]);
    	}

    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[16](/*vare*/ ctx[32]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "name", "");
    			attr_dev(input0, "id", "");
    			add_location(input0, file, 122, 19, 4221);
    			set_style(td0, "display", "flex");
    			set_style(td0, "justify-content", "center");
    			set_style(td0, "align-items", "center");
    			set_style(td0, "width", "100%");
    			set_style(td0, "height", "100%");
    			add_location(td0, file, 121, 16, 4102);
    			attr_dev(input1, "type", "text");
    			set_style(input1, "all", "unset");
    			set_style(input1, "width", "100%");
    			set_style(input1, "height", "100%");
    			set_style(input1, "margin", "0px");
    			set_style(input1, "background", "none");
    			add_location(input1, file, 124, 63, 4417);
    			set_style(td1, "color", "#373A86");
    			set_style(td1, "font-weight", "3000");
    			add_location(td1, file, 124, 16, 4370);
    			attr_dev(input2, "type", "text");
    			set_style(input2, "all", "unset");
    			set_style(input2, "width", "100%");
    			set_style(input2, "height", "100%");
    			set_style(input2, "margin", "0px");
    			set_style(input2, "background", "none");
    			add_location(input2, file, 125, 63, 4633);
    			set_style(td2, "font-weight", "500");
    			set_style(td2, "text-align", "left");
    			add_location(td2, file, 125, 16, 4586);
    			attr_dev(input3, "type", "text");
    			set_style(input3, "all", "unset");
    			set_style(input3, "width", "100%");
    			set_style(input3, "height", "100%");
    			set_style(input3, "margin", "0px");
    			set_style(input3, "background", "none");
    			add_location(input3, file, 126, 46, 4833);
    			set_style(td3, "text-align", "center");
    			add_location(td3, file, 126, 16, 4803);
    			attr_dev(a, "href", "#");
    			add_location(a, file, 129, 18, 5108);
    			set_style(td4, "text-align", "center");
    			add_location(td4, file, 128, 16, 5058);
    			if (!src_url_equal(button.src, button_src_value = "../public/trash_icon.png")) attr_dev(button, "src", button_src_value);
    			set_style(button, "margin", "0px");
    			set_style(button, "box-sizing", "border-box ");
    			set_style(button, "width", "15px");
    			...
    			set_style(button, "background-color", "#751201");
    			set_style(button, "border-radius", "24px");
    			add_location(button, file, 138, 19, 5487);
    			set_style(td5, "display", "flex");
    			set_style(td5, "justify-content", "center");
    			set_style(td5, "align-items", "center");
    			set_style(td5, "margin", "0px");
    			set_style(td5, "height", "30px");
    			add_location(td5, file, 137, 16, 5369);
    			set_style(tr, "height", "35px");
    			attr_dev(tr, "class", "" + (null_to_empty(/*i*/ ctx[34] % 2 === 0 ? "odd" : "even") + " svelte-1er8x9u"));
    			add_location(tr, file, 120, 14, 3987);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    			append_dev(td0, input0);
    			input0.checked = /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].checked;
    			append_dev(tr, t0);
    			append_dev(tr, td1);
    			append_dev(td1, input1);
    			set_input_value(input1, /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Varenummer);
    			append_dev(tr, t1);
    			append_dev(tr, td2);
    			append_dev(td2, input2);
    			set_input_value(input2, /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Produktnavn);
    			append_dev(tr, t2);
    			append_dev(tr, td3);
    			append_dev(td3, input3);
    			set_input_value(input3, /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Pris);
    			append_dev(tr, t3);
    			append_dev(tr, td4);
    			append_dev(td4, a);
    			append_dev(tr, t5);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*varer, visibleVarer*/ 34) {
    				input0.checked = /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].checked;
    			}

    			if (dirty[0] & /*varer, visibleVarer*/ 34 && input1.value !== /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Varenummer) {
    				set_input_value(input1, /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Varenummer);
    			}

    			if (dirty[0] & /*varer, visibleVarer*/ 34 && input2.value !== /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Produktnavn) {
    				set_input_value(input2, /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Produktnavn);
    			}

    			if (dirty[0] & /*varer, visibleVarer*/ 34 && input3.value !== /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Pris) {
    				set_input_value(input3, /*varer*/ ctx[1][/*vare*/ ctx[32].originalIndex].Pris);
    			}
    		},
    		i: function intro(local) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(120:12) {#each visibleVarer as vare, i}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function header_slettetVarer_binding(value) {
    		/*header_slettetVarer_binding*/ ctx[10](value);
    	}

    	let header_props = {};

    	if (/*søgning*/ ctx[2] !== void 0) {
    		header_props.søgning = /*søgning*/ ctx[2];
    	}

    	if (/*varer*/ ctx[1] !== void 0) {
    		header_props.varer = /*varer*/ ctx[1];
    	}

    	if (/*slettetVarer*/ ctx[0] !== void 0) {
    		header_props.slettetVarer = /*slettetVarer*/ ctx[0];
    	}
    	...
    	binding_callbacks.push(() => bind(header, 'slettetVarer', header_slettetVarer_binding));
    	let each_value = /*visibleVarer*/ ctx[5];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	function table1_favoriteVisible_binding(value) {
    		/*table1_favoriteVisible_binding*/ ctx[17](value);
    	}

    	function table1_loading_binding(value) {
    		/*table1_loading_binding*/ ctx[18](value);
    	}

    	function table1_images_binding(value) {
    		/*table1_images_binding*/ ctx[19](value);
    	}

    	function table1_varer_binding(value) {
    		/*table1_varer_binding*/ ctx[20](value);
    	}

    	function table1_slettetVarer_binding(value) {
    		/*table1_slettetVarer_binding*/ ctx[21](value);
    	}

    	let table1_props = {};

    	if (/*favoriteVisible*/ ctx[6] !== void 0) {
    		table1_props.favoriteVisible = /*favoriteVisible*/ ctx[6];
    	}

    	if (/*loading*/ ctx[4] !== void 0) {
    		table1_props.loading = /*loading*/ ctx[4];
    	}

    	if (/*images*/ ctx[3] !== void 0) {
    		table1_props.images = /*images*/ ctx[3];
    	}

    	if (/*varer*/ ctx[1] !== void 0) {
    		table1_props.varer = /*varer*/ ctx[1];
    	}

    	if (/*slettetVarer*/ ctx[0] !== void 0) {
    		table1_props.slettetVarer = /*slettetVarer*/ ctx[0];
    	}
    	...
    	binding_callbacks.push(() => bind(table1, 'slettetVarer', table1_slettetVarer_binding));

    	function footer_varer_binding(value) {
    		/*footer_varer_binding*/ ctx[22](value);
    	}

    	function footer_favoriteVisible_binding(value) {
    		/*footer_favoriteVisible_binding*/ ctx[23](value);
    	}

    	let footer_props = {};

    	if (/*varer*/ ctx[1] !== void 0) {
    		footer_props.varer = /*varer*/ ctx[1];
    	}

    	if (/*favoriteVisible*/ ctx[6] !== void 0) {
    		footer_props.favoriteVisible = /*favoriteVisible*/ ctx[6];
    	}
    	...
    	function fileviewer_images_binding(value) {
    		/*fileviewer_images_binding*/ ctx[24](value);
    	}

    	function fileviewer_loading_binding(value) {
    		/*fileviewer_loading_binding*/ ctx[25](value);
    	}

    	let fileviewer_props = {};

    	if (/*images*/ ctx[3] !== void 0) {
    		fileviewer_props.images = /*images*/ ctx[3];
    	}

    	if (/*loading*/ ctx[4] !== void 0) {
    		fileviewer_props.loading = /*loading*/ ctx[4];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(th0, "width", "55px");
    			add_location(th0, file, 110, 14, 3602);
    			set_style(th1, "width", "160px");
    			add_location(th1, file, 111, 14, 3644);
    			add_location(th2, file, 112, 14, 3700);
    			set_style(th3, "width", "160px");
    			add_location(th3, file, 113, 14, 3735);
    			set_style(th4, "width", "160px");
    			add_location(th4, file, 114, 14, 3795);
    			set_style(th5, "width", "35px");
    			add_location(th5, file, 115, 14, 3838);
    			set_style(tr, "position", "sticky");
    			set_style(tr, "top", "0px");
    			set_style(tr, "height", "30px");
    			set_style(tr, "overflow", "hidden");
    			set_style(tr, "background-color", "#2B2F42");
    			set_style(tr, "color", "white");
    			add_location(tr, file, 109, 12, 3476);
    			set_style(thead, "border-radius", "15px");
    			add_location(thead, file, 108, 10, 3428);
    			add_location(tbody, file, 118, 10, 3921);
    			...
    			attr_dev(table0, "class", "svelte-1er8x9u");
    			add_location(table0, file, 107, 8, 3306);
    			attr_dev(div0, "class", "wrap svelte-1er8x9u");
    			set_style(div0, "height", "calc(100% - " + (/*favoriteVisible*/ ctx[6] ? '305' : '100') + "px)");
    			add_location(div0, file, 106, 6, 3214);
    			attr_dev(div1, "class", "table svelte-1er8x9u");
    			set_style(div1, "box-sizing", "content-box");
    			add_location(div1, file, 105, 4, 3155);
    			attr_dev(div2, "class", "container svelte-1er8x9u");
    			add_location(div2, file, 103, 2, 3070);
    			attr_dev(div3, "id", "clickable-area");
    			attr_dev(div3, "class", "clickable-area svelte-1er8x9u");
    			add_location(div3, file, 160, 4, 6294);
    			attr_dev(dialog, "class", "billeder svelte-1er8x9u");
    			attr_dev(dialog, "id", "billeder");
    			add_location(dialog, file, 159, 2, 6250);
    			add_location(script0, file, 164, 2, 6414);
    			if (!src_url_equal(script1.src, script1_src_value = "./renderer.js")) attr_dev(script1, "src", script1_src_value);
    			add_location(script1, file, 170, 2, 6693);
    			attr_dev(main, "class", "svelte-1er8x9u");
    			add_location(main, file, 101, 0, 2969);
    		},
    		l: function claim(nodes) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_søgning && dirty[0] & /*søgning*/ 4) {
    				updating_søgning = true;
    				header_changes.søgning = /*søgning*/ ctx[2];
    				add_flush_callback(() => updating_søgning = false);
    			}

    			if (!updating_varer && dirty[0] & /*varer*/ 2) {
    				updating_varer = true;
    				header_changes.varer = /*varer*/ ctx[1];
    				add_flush_callback(() => updating_varer = false);
    			}

    			if (!updating_slettetVarer && dirty[0] & /*slettetVarer*/ 1) {
    				updating_slettetVarer = true;
    				header_changes.slettetVarer = /*slettetVarer*/ ctx[0];
    				add_flush_callback(() => updating_slettetVarer = false);
    			}

    			header.$set(header_changes);

    			if (dirty[0] & /*slettetVarer, varer, visibleVarer, imagegallery*/ 163) {
    				each_value = /*visibleVarer*/ ctx[5];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (!updating_favoriteVisible && dirty[0] & /*favoriteVisible*/ 64) {
    				updating_favoriteVisible = true;
    				table1_changes.favoriteVisible = /*favoriteVisible*/ ctx[6];
    				add_flush_callback(() => updating_favoriteVisible = false);
    			}

    			if (!updating_loading && dirty[0] & /*loading*/ 16) {
    				updating_loading = true;
    				table1_changes.loading = /*loading*/ ctx[4];
    				add_flush_callback(() => updating_loading = false);
    			}

    			if (!updating_images && dirty[0] & /*images*/ 8) {
    				updating_images = true;
    				table1_changes.images = /*images*/ ctx[3];
    				add_flush_callback(() => updating_images = false);
    			}

    			if (!updating_varer_1 && dirty[0] & /*varer*/ 2) {
    				updating_varer_1 = true;
    				table1_changes.varer = /*varer*/ ctx[1];
    				add_flush_callback(() => updating_varer_1 = false);
    			}

    			if (!updating_slettetVarer_1 && dirty[0] & /*slettetVarer*/ 1) {
    				updating_slettetVarer_1 = true;
    				table1_changes.slettetVarer = /*slettetVarer*/ ctx[0];
    				add_flush_callback(() => updating_slettetVarer_1 = false);
    			}

    			table1.$set(table1_changes);

    			if (!current || dirty[0] & /*favoriteVisible*/ 64) {
    				set_style(div0, "height", "calc(100% - " + (/*favoriteVisible*/ ctx[6] ? '305' : '100') + "px)");
    			}

    			const footer_changes = {};

    			if (!updating_varer_2 && dirty[0] & /*varer*/ 2) {
    				updating_varer_2 = true;
    				footer_changes.varer = /*varer*/ ctx[1];
    				add_flush_callback(() => updating_varer_2 = false);
    			}

    			if (!updating_favoriteVisible_1 && dirty[0] & /*favoriteVisible*/ 64) {
    				updating_favoriteVisible_1 = true;
    				footer_changes.favoriteVisible = /*favoriteVisible*/ ctx[6];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function imagegallery(vn) {
    		...
    		try {
    			...
    			if (imageNames && imageNames.length > 0) {
    				console.log(imageNames);
    				$$invalidate(3, images = imageNames.map(imageName => ({ name: imageName, src: imageName })));
    			} else {
    				console.warn("No images found for the specified product.");
    				$$invalidate(3, images = []);
    				$$invalidate(4, loading = false);
    	...
    	function header_slettetVarer_binding(value) {
    		slettetVarer = value;
    		$$invalidate(0, slettetVarer);
    	}

    	function input0_change_handler(vare) {
    		varer[vare.originalIndex].checked = this.checked;
    		$$invalidate(1, varer);
    	}

    	function input1_input_handler(vare) {
    		varer[vare.originalIndex].Varenummer = this.value;
    		$$invalidate(1, varer);
    	}

    	function input2_input_handler(vare) {
    		varer[vare.originalIndex].Produktnavn = this.value;
    		$$invalidate(1, varer);
    	}

    	function input3_input_handler(vare) {
    		varer[vare.originalIndex].Pris = this.value;
    		$$invalidate(1, varer);
    	}

    	const click_handler = vare => {
    		imagegallery(varer[vare.originalIndex].Varenummer);
    	};

    	const click_handler_1 = vare => {
    		slettetVarer.push(varer[vare.originalIndex]);
    		console.log(varer.splice(vare.originalIndex, 1));
    		$$invalidate(1, varer);
    	};

    	function table1_favoriteVisible_binding(value) {
    		favoriteVisible = value;
    		$$invalidate(6, favoriteVisible);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('slettetVarer' in $$props) $$invalidate(0, slettetVarer = $$props.slettetVarer);
    		if ('varer' in $$props) $$invalidate(1, varer = $$props.varer);
    		if ('data' in $$props) data = $$props.data;
    		if ('done' in $$props) done = $$props.done;
    		if ('visibleVarer' in $$props) $$invalidate(5, visibleVarer = $$props.visibleVarer);
    		if ('søgning' in $$props) $$invalidate(2, søgning = $$props.søgning);
    		if ('p' in $$props) p = $$props.p;
    		if ('images' in $$props) $$invalidate(3, images = $$props.images);
    		if ('favoriteVisible' in $$props) $$invalidate(6, favoriteVisible = $$props.favoriteVisible);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*slettetVarer*/ 1) {
    			$$invalidate(0, slettetVarer);
    		}

    		if ($$self.$$.dirty[0] & /*varer*/ 2) {
    			$$invalidate(1, varer);
    		}

    		if ($$self.$$.dirty[0] & /*varer, søgning*/ 6) {
    			$$invalidate(5, visibleVarer = varer.map((item, index) => ({ ...item, originalIndex: index })).filter(vare => (vare.Varenummer + "").toLowerCase().includes(søgning.toLowerCase()) || (vare.Produktnavn + "").toLowerCase().includes(søgning.toLowerCase())));
    		}
    	...
    	$$invalidate(6, favoriteVisible = false); //the favorites bar, changes css
