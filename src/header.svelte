 ...
 export let slettetVarer = [];
  ...
  async function regret() {
    ...
    if (typeof(myVariable) != "undefined") {
        ...
        varer.sort((a, b) => a.Varenummer - b.Varenummer); varer = varer;
    }
  }
...
<main>
    ...
    <div class="search">
        ...
        <button class="but" id="fortryd" on:click={() => {let popp = slettetVarer.pop(); let vare = { Varenummer: popp.Varenummer, Produktnavn: popp.Produktnavn, Pris: popp.Pris, checked: popp.checked}; if(typeof popp !== 'undefined') {varer.push(Object.assign({}, vare)); varer.sort((a, b) => a.Varenummer - b.Varenummer); varer = varer;}}} style="left: {loading ? '190px' : '155px'}; margin: 0px; margin-top: -1px; margin-bottom: 8px; font-size:small; position:absolute; bottom: 1px; height: 2.5em; max-width: 200px;">Fortryd</button>
